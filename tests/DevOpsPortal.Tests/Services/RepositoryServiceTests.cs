...
public class RepositoryServiceTests
{
    private static RepositoryService CreateSut()
    {
        ...
        return new RepositoryService(db, new AuditService(db, new FakeCurrentUserService(), currentTenant), currentTenant);
    }
    ...
    public async Task CreateAsync_WithValidHttpsUrl_Succeeds()
    {
        ...
        var dto = await sut.CreateAsync(new CreateRepositoryRequest(
            "sample-repo", "https://gitlab.example.com/group/sample-repo.git", RepositoryProvider.GitLab, null, null));
    ...
    public async Task CreateAsync_WithEmbeddedCredentialsInUrl_ThrowsValidation()
    {
        ...
        await Assert.ThrowsAsync<ValidationException>(() => sut.CreateAsync(new CreateRepositoryRequest(
            "sample-repo", "https://user:secretpassword@gitlab.example.com/group/repo.git", RepositoryProvider.GitLab, null, null)));
    }
    ...
    public async Task CreateAsync_WithInvalidUrl_ThrowsValidation(string url)
    {
        ...
        await Assert.ThrowsAsync<ValidationException>(() =>
            sut.CreateAsync(new CreateRepositoryRequest("sample-repo", url, RepositoryProvider.GitLab, null, null)));
    }
    ...
    {
        var sut = CreateSut();
        await sut.CreateAsync(new CreateRepositoryRequest("sample-repo", "https://gitlab.example.com/a.git", RepositoryProvider.GitLab, null, null));

        await Assert.ThrowsAsync<ConflictException>(() =>
            sut.CreateAsync(new CreateRepositoryRequest("sample-repo", "https://gitlab.example.com/b.git", RepositoryProvider.GitLab, null, null)));
    }
    ...
    public async Task CreateAsync_WithValidAccessTokenEnvVarName_Succeeds()
    {
        ...
        var dto = await sut.CreateAsync(new CreateRepositoryRequest(
            "sample-repo", "https://gitlab.example.com/group/sample-repo.git", RepositoryProvider.GitLab, null, "GITLAB_TOKEN_SAMPLE"));
    ...
    public async Task CreateAsync_WithInvalidAccessTokenEnvVarName_ThrowsValidation(string envVarName)
    {
        ...
        await Assert.ThrowsAsync<ValidationException>(() => sut.CreateAsync(new CreateRepositoryRequest(
            "sample-repo", "https://gitlab.example.com/group/sample-repo.git", RepositoryProvider.GitLab, null, envVarName)));
    }
}
